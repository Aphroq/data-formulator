...
export interface TransformParameterSlot {
    id: string;
    name: string;
    description?: string;
...
export interface DraftNode {
    ...
    derive: {
        ...
        parameterSlots?: TransformParameterSlot[];
        dialog?: any[];
...
export interface DictTable {
    ...
    derive?: { // how is this table derived
        ...
        parameterSlots?: TransformParameterSlot[], // immutable typed values read through params["slot_id"]
        explanation?: {
